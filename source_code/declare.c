...
int exact=-9999;
int scoretest=-9999;
char locofile2[500]="blank", locofile[500]="";
char bocofile2[500]="blank", bocofile[500]="";
...
char **preds, **allpreds;
char *al1, *al2, *allal1, *allal2, **fullal1, **fullal2;
...
double *centres, *mults, *sqdevs, *weights, *pvalues;
...
double *rdata, *rcentres, *rmults, *rsqdevs,  *rweights;
char **rpreds, *ral1, *ral2;

int num_resps, num_resps_use, *keepresps, *keepresps2, *respcounts, *respcounts2, *respinds, *respinds2;
double *resp, *resp2;
...
double *covar, *thetas, *thetasds, *thetapvas, *savethetas, covher, topher;
...
double *infos, *cors, *cors2, *datasqs, *tally1, *tally2, *tally3, *tally4;
int *replace;
...
double *sweights;
double invDTD[4];
double *nullprobs, *nullweights;
double scal1, scal2, *prs;
...
int useped, forceridge, usecal;

int *pedtops;
double *pedscales, *pedhers, *pedprs, *pedgammas, *pedsds, *pedmse;

int *cindex, *cindex2;
double *cdata, *ccentres, *cmults, *csqdevs;
char **cpreds;

int *dindex, *dindex2;
double *ddata, *dcentres, *dmults, *dsqdevs;
char **dpreds;
...
double *cgammas, *csds;
double *effs, *effs2, *probs, *probs2, *residuals, *residuals2, *changes;

int *bitdo, *bitactive, *bitdet1, *bitdet2;
double *bitdiffs, *bitpens;

int *Mtops, *Mbests, *Mincs;
double *Mscales, *Mmses, *Mneffs;
...
int num_scores=0;
double *predmeans, *predvars, *predcors, *predsds;
double **unders, **phens, *vsds, *veffs, *vadds, **liabs;

int numa, *keepa, numb, *keepb;
double *acentres, *amults, *bcentres, *bmults, *asqdevs, *bsqdevs;
char **apreds, **bpreds;
...
int shuffle, start, end, best, mark, mark2, gen, gen2, *gens, flag, cflag, eflag, hflag, sflag, *order, *order2, cols[6];
...
double likenull, like, lrtstat, lrtpva, *likes, *likesold, diff;
double neff, neff2, *pens, factor;
...
char readchar, readchar2, *rs, readstring[500], readstring2[500], readstring3[500], readstring4[500], readstring5[500];
