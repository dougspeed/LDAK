...
(void)read_data_fly(datafile, dtype, data, NULL, num_samples_use, keepsamps, 0, data_length, keeppreds_use, datainputgz, 0, num_samples, num_preds, genskip, genheaders, genprobs, bedbytes, missingvalue, -9999, -9999, nonsnp, maxthreads);
