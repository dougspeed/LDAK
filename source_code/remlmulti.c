...
if(shortcut==0||shortcut==1){he_starts(hers, ns, num_covars, num_envs, num_tops, num_kins, num_regs, Y, Z, Mkins, NULL, kintraces, X, Xtotal, Xstarts, Xends, Xsums, memsave, maxthreads, kinstems, ids3);}
else{he_starts(hers, ns, num_covars, num_envs, num_tops, num_kins, num_regs, Y, Z, NULL, Mkins_single, kintraces, X, Xtotal, Xstarts, Xends, Xsums, memsave, maxthreads, kinstems, ids3);}
