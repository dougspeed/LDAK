...
if(skipcv==0)	//make and test training models plus MCMC REML
{
...
while(1)
{
if(count==maxiter){printf("\nWarning, Variational Bayes did not converge after %d iterations; consider using \"--max-iter\" and/or \"--tolerance\" to increase the iteration limit and tolerance\n", count);break;}
...
if(her==-9999)	//compute revised heritabilities
{
for(m=0;m<num_resps_use;m++)
{
