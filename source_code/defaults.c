...
if(seed==-9999)	//use random numbers to seed srand and zigset
{
//set random seed
...
switch((i >> 2*j) & 3)
{
case 3: bedbytes[i*4+j]=0;break;
case 2: bedbytes[i*4+j]=1;break;
case 0: bedbytes[i*4+j]=2;break;
case 1: bedbytes[i*4+j]=missingvalue;break;
}
}
}
