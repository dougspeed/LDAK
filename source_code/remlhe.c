...
int he_starts(double *hers, int ns, int num_covars, int num_envs, int num_tops, int num_kins, int num_regs, double *Y, double *Z, double **Mkins, float **Mkins_single, double *kintraces, double *X, int Xtotal, int *Xstarts, int *Xends, double *Xsums, int memsave, int maxthreads, char **kinstems, char **ids3)
{
