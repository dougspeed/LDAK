...
mean=sum/num_blocks;
var=(num_blocks-1)*(sumsq/num_blocks-pow(mean,2));
printf("\nWeighted correlation is %.4f (SE %.4f)\n", value, pow(var,.5));
...
mean=sum/num_blocks;
var=(num_blocks-1)*(sumsq/num_blocks-pow(mean,2));
printf("Weighted correlation squared is %.4f (SE %.4f)\n", pow(value,2), pow(var,.5));
...
mean=sum/num_blocks;
var=(num_blocks-1)*(sumsq/num_blocks-pow(mean,2));
printf("Weighted mean squared error is %.4f (SE %.4f)\n", value2/value5, pow(var,.5)/value5);
...
mean=sum/num_blocks;
var=(num_blocks-1)*(sumsq/num_blocks-pow(mean,2));
printf("Weighted mean absolute error is %.4f (SE %.4f)\n", value3*pow(value5,-.5), pow(var,.5)*pow(value5,-.5));
