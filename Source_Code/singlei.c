...
{
reg_covar_log(Y+m*num_samples_use, Z, num_samples_use, num_fixed, 0, offsets, thetas+m*num_fixed, thetasds+m*num_fixed, thetapvas+m*num_fixed, NULL, -9999, NULL, NULL, -9999, 0.001, 100);
}
...
if(adjpreds==1)	//fill Z3 with WZ for each phenotype, then get Z2 = Z inv(ZTZ3)
{
for(m=0;m<num_resps_use;m++)
{
...
if(scoretest==1)
{
//get XTY for all phenotypes at once
alpha=1.0;beta=0.0;
