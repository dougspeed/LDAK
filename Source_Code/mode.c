...
//List of possible modes (D/d indicates data required/possible; K/k, R/r, T/t, P/p, S/s, same for kinships, regions, tops, phenotypes, summaries - ignores fact that phenotypes can be used for filtering samples)
