...
stand_data(data+(size_t)shuffle*num_samples_use, centres+gstarts[g]+shuffle, mults+gstarts[g]+shuffle, sqdevs+gstarts[g]+shuffle, rates+gstarts[g]+shuffle, infos+gstarts[g]+shuffle, num_samples_use, total-shuffle, missingvalue, -1, 0, 0, NULL, 1);
