...
{
if(mode!=102&&mode!=104&&mode!=123&&mode!=124)
...
if(minmaf!=-9999&&mode!=131&&mode!=132&&mode!=134&&mode!=151&&mode!=152&&mode!=153&&mode!=154&&mode!=156&&mode!=171&&mode!=181&&mode!=182&&mode!=183&&mode!=184&&mode!=185&&mode!=186&&mode!=187&&mode!=188&&mode!=189)
{printf("Error, you can only use \"--min-maf\" with \"--linear\", \"--logistic\", \"--ridge\", \"--bolt\", \"--bayesr\", \"--elastic\", \"--calc-cors\", \"--calc-stats\" or when making or condensing data; either first remake the data, or use \"--extract\" or \"--exclude\" to specify which predictors to analyse (you can use \"--calc-stats\" to calculate predictor allele frequencies)\n\n");exit(1);}

if(maxmaf!=-9999&&mode!=131&&mode!=132&&mode!=134&&mode!=151&&mode!=152&&mode!=153&&mode!=154&&mode!=181&&mode!=182&&mode!=183&&mode!=184&&mode!=185&&mode!=186&&mode!=187&&mode!=188&&mode!=189)
{printf("Error, you can only use \"--max-maf\" with \"--linear\", \"--logistic\", \"--ridge\", \"--bolt\", \"--bayesr\", \"--elastic\" or when making or condensing data; either first remake the data, or use \"--extract\" or \"--exclude\" to specify which predictors to analyse (you can use \"--calc-stats\" to calculate predictor allele frequencies)\n\n");exit(1);}
...
if(minvar!=-9999&&mode!=131&&mode!=132&&mode!=134&&mode!=151&&mode!=152&&mode!=153&&mode!=154&&mode!=181&&mode!=182&&mode!=183&&mode!=184&&mode!=185&&mode!=186&&mode!=187&&mode!=188&&mode!=189)
{printf("Error, you can only use \"--min-var\" with \"--linear\", \"--logistic\", \"--ridge\", \"--bolt\", \"--bayesr\", \"--elastic\" or when making or condensing data; either first remake the data, or use \"--extract\" or \"--exclude\" to specify which predictors to analyse\n\n");exit(1);}

if(minobs!=-9999&&mode!=131&&mode!=132&&mode!=134&&mode!=151&&mode!=152&&mode!=153&&mode!=154&&mode!=181&&mode!=182&&mode!=183&&mode!=184&&mode!=185&&mode!=186&&mode!=187&&mode!=188&&mode!=189)
{printf("Error, you can only use \"--min-obs\" with \"--linear\", \"--logistic\", \"--ridge\", \"--bolt\", \"--bayesr\", \"--elastic\" or when making or condensing data; either first remake the data, or use \"--extract\" or \"--exclude\" to specify which predictors to analyse (you can use \"--calc-stats\" to calculate call-rates)\n\n");exit(1);}

if(mininfo!=-9999&&mode!=131&&mode!=132&&mode!=134&&mode!=151&&mode!=152&&mode!=153&&mode!=154&&mode!=181&&mode!=182&&mode!=183&&mode!=184&&mode!=185)
{printf("Error, you can only use \"--min-info\" with \"--linear\", \"--logistic\", \"--ridge\", \"--bolt\", \"--bayesr\", \"--elastic\" or when making data (and when providing genotype probabilities)\n\n");exit(1);}
...
if(mpheno==-1&&mode==140)
{printf("Error, you can not use \"--mpheno ALL\" with \"--kvik-step3\"; please instead run the analysis multiple times, first using \"--mpheno 1\", then \"--mpheno 2\", and so on\n\n");exit(1);}

if(mpheno==-1&&mode!=121&&mode!=123&&mode!=124&&mode!=126&&mode!=129&&mode!=130&&mode!=131&&mode!=132&&mode!=134&&mode!=151&&mode!=152&&mode!=153&&mode!=154&&mode!=163)
{printf("Error, you can only use \"--mpheno ALL\" with \"--reml\", \"--he\", \"--pcgc\", \"--fast-reml\", \"--quant-her\", \"--tetra-her\", \"--linear\", \"--logistic\", \"--ridge\", \"--bolt\", \"--bayesr\", \"--elastic\" or \"--decompose\"\n\n");exit(1);}
...
{
if(mode!=121&&mode!=138&&mode!=146&&mode!=147&&mode!=150&&mode!=158&&mode!=159&&mode!=172&&mode!=179)
...
{printf("Error, you can only use \"--fixed-n\" with \"--summary\"\n\n");exit(1);}

if(fixn2!=-9999&&strcmp(sumsfile2,"blank")==0)
{printf("Error, you can only use \"--fixed-n2\" with \"--summary2\"\n\n");exit(1);}

if(amb!=-9999&&strcmp(sumsfile,"blank")==0&&mode!=140)
{printf("Error, you can only use \"--allow-ambiguous\" with \"--summary\"\n\n");exit(1);}
...
if(prev!=-9999&&strcmp(pathfile,"blank")!=0)
...
if(strcmp(sampwfile,"blank")!=0&&mode==131&&strcmp(prsfile,"blank")!=0)
...
if(sandwich==1&&strcmp(prsfile,"blank")!=0)
{printf("Error, you can not use \"--sandwich YES\" with \"--PRS\"\n\n");exit(1);}
...
if(strcmp(genpreds,"blank")!=0&&strcmp(labfile,"blank")==0)
...
if(savemat==1&&strcmp(genpreds,"blank")!=0)
{printf("Error, you can not use \"--save-matrix YES\" with \"--genic-predictors\"\n\n");exit(1);}
...
if(strcmp(matlist,"blank")!=0&&strcmp(pathlist,"blank")!=0)
{printf("Error, you can not use \"--matlist\" with \"--pathlist\"\n\n");exit(1);}
...
if(strcmp(pathfile,"blank")!=0&&mode!=146)
...
if(strcmp(cvsfile,"blank")!=0&&strcmp(pathfile,"blank")!=0)
...
if(strcmp(catfile,"blank")!=0&&strcmp(pathfile,"blank")!=0)
...
if(strcmp(taufile,"blank")!=0&&strcmp(pathfile,"blank")!=0)
...
if(checksums!=-9999&&mode!=146&&mode!=147&&mode!=158&&mode!=159)
{printf("Error, you can only use \"--check-sums\" with \"--sum-hers\", \"--sum-cors\", \"--pseudo-summaries\" or \"--mega-prs\"\n\n");exit(1);}
...
if(ldsc==1&&strcmp(pathfile,"blank")!=0)
...
if(tagone==1&&strcmp(pathfile,"blank")!=0)
...
if(divide!=-9999&&strcmp(pathfile,"blank")!=0)
...
if(uptaus==1&&strcmp(pathfile,"blank")!=0)
...
if(strcmp(powfile,"blank")!=0&&strcmp(pathfile,"blank")!=0)
...
if(strcmp(matfile,"blank")!=0&&strcmp(pathfile,"blank")!=0)
...
if(strcmp(fastfile,"blank")!=0&&fastgwa!=1)
{printf("Error, you can only use \"--grm-sparse\" with \"--fastGWA YES\"\n\n");exit(1);}
...
{printf("Error, you can only use \"--max-her\" with \"--ridge\", \"--bolt\", \"--bayesr\", \"--elastic\" or \"--mega-prs\"\n\n");exit(1);}
...
if(revher!=-9999&&her!=-9999)
{printf("Error, you can not use \"--revise-heritability\" if using \"--her\"\n\n");exit(1);}
...
if(checkfreq!=-9999&&mode!=159)
{printf("Error, you can only use \"--check-frequencies\" with \"--mega-prs\"\n\n");exit(1);}
...
if(jackprop!=-9999&&mode!=159)
{printf("Error, you can only use \"--jackknife-proportion\" with \"--mega-prs\"\n\n");exit(1);}

if(jackprop!=-9999&&prsvar!=1)
{printf("Error, you can only use \"--jackknife-proportion\" with \"--PRS-variance YES\"\n\n");exit(1);}
...
if(cutoff!=-9999&&mode!=107&&mode!=110&&mode!=146&&mode!=147&&mode!=166&&mode!=179)
{printf("Error, you can only use \"--cutoff\" with \"--sum-hers\", \"--sum-cors\", \"--truncate-grm\", \"--thin-tops\", \"--thin-common\" or \"--winners-curse\"\n\n");exit(1);}
...
if(num_blocks!=-9999&&mode!=123&&mode!=124&&mode!=127&&mode!=128&&mode!=129&&mode!=130&&mode!=229&&mode!=230&&mode!=146&&mode!=147&&mode!=156&&mode!=176)
{printf("Error, you can only use \"--num-blocks\" with \"--he\", \"--pcgc\", \"--fast-he\", \"--fast-pcgc\", \"--quant-her\", \"--quant-her\", \"--sum-hers\", \"--sum-cors\", \"--calc-cors\" or \"--jackknife\"\n\n");exit(1);}
...
if(permute!=-9999&&mode!=121&&mode!=123&&mode!=124&&mode!=126&&mode!=127&&mode!=128&&mode!=129&&mode!=130&&mode!=229&&mode!=230&&mode!=131&&mode!=132&&mode!=134&&mode!=138&&mode!=176)
