...
if(append_check(sumslist,sumslist2,workdir)!=0)
{printf("Error reading summaries list %s; check file exists and is not empty\n\n", sumslist);exit(1);}
if(append_check(bulkfile,bulkfile2,workdir)!=0)
{printf("Error reading bulk summaries %s; check file exists and is not empty\n\n", bulkfile);exit(1);}
...
if(append_check(rovarfile,rovarfile2,workdir)!=0)
{printf("Error reading random-covariates file %s; check file exists and is not empty\n\n", rovarfile);exit(1);}
if(append_check(ractorfile,ractorfile2,workdir)!=0)
{printf("Error reading random factor file %s; check file exists and is not empty\n\n", ractorfile);exit(1);}
...
(void)append_check(prsfile,prsfile2,workdir);
(void)append_check(assfile,assfile2,workdir);

////////

if(append_check(sexfile,sexfile2,workdir)!=0)
{printf("Error reading sex file %s; check file exists and is not empty\n\n", sexfile);exit(1);}
...
(void)append_check(transfile,transfile2,workdir);
...
if(append_check(pathfile,pathfile2,workdir)!=0)
{printf("Error reading pathway genes file %s; check file exists and is not empty\n\n", pathfile);exit(1);}

////////

(void)append_check(annpref,annpref2,workdir);
(void)append_check(genpreds,genpreds2,workdir);
...
if(append_check(xaglist,xaglist2,workdir)!=0)
{printf("Error reading list of cross-ancestry tagging files %s; check file exists and is not empty\n\n", xaglist);exit(1);}
if(append_check(pathlist,pathlist2,workdir)!=0)
{printf("Error reading list of pathway stems %s; check file exists and is not empty\n\n", pathlist);exit(1);}

if(append_check(tagfile,tagfile2,workdir)!=0)
{printf("Error reading tagging file %s; check file exists and is not empty\n\n", tagfile);exit(1);}
if(append_check(xagfile,xagfile2,workdir)!=0)
{printf("Error reading cross tagging file %s; check file exists and is not empty\n\n", xagfile);exit(1);}
(void)append_check(wayfile,wayfile2,workdir);
...
if(append_check(blockfile,blockfile2,workdir)!=0)
{printf("Error reading block details file %s; check file exists and is not empty\n\n", blockfile);exit(1);}
if(append_check(betafile,betafile2,workdir)!=0)
{printf("Error reading beta file %s; check file exists and is not empty\n\n", betafile);exit(1);}
...
{printf("Error reading parameters file %s; check file exists and is not empty\n\n", fracfile);exit(1);}
...
if(append_check(morefile,morefile2,workdir)!=0)
{printf("Error reading multi score file %s; check file exists and is not empty\n\n", morefile);exit(1);}
