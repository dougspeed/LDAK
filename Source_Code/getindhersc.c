...
//Code allows for dichot=0 and sample weights, even though neither currently possible (only here for structured binary phenotypes)
...
value=(double)num_samples_use/1024/1024/1024*8*total*ndivs*num_pows;
...
if(value2>maxcor)	//blank the corresponding columns of RTdata
{
