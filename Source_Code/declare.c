...
char sumslist2[500]="blank", sumslist[500]="";
char bulkfile2[500]="blank", bulkfile[500]="";
...
char rovarfile2[500]="blank", rovarfile[500]="";
char ractorfile2[500]="blank", ractorfile[500]="";
...
char assfile2[500]="blank", assfile[500]="";
int checkprs=-9999;
...
int drm=-9999;
int xpar=-9999;
char sexfile2[500]="blank", sexfile[500]="";
...
char xaglist2[500]="blank", xaglist[500]="";
char pathlist2[500]="blank", pathlist[500]="";
int checkdups=-9999;

char tagfile2[500]="blank", tagfile[500]="";
char xagfile2[500]="blank", xagfile[500]="";
char wayfile2[500]="blank", wayfile[500]="";
...
char betafile2[500]="blank", betafile[500]="blank";
...
int Lnum=-9999;
int num_grids=-9999;
double grid_min=-9999, grid_max=-9999;
double csalpha=-9999;
int impsums=-9999;
...
//stats, scores, making phenotypes, snps, inflation, jackknifing, folds, find gaussian, winners curse and impute summaries

char scorefile2[500]="blank", scorefile[500]="";
char morefile2[500]="blank", morefile[500]="";
...
int num_samples=-9999, num_samples_use=-9999, num_samples_use2, *keepsamps, *keepsamps2, **subindex;
...
int *chr, *allchr, num_chr, num_chr2, *chrindex, *chrindex2;
...
float **ps, **ps2;
double *centres, *centres2, *mults, *sqdevs, *rates, *infos, *weights, *pvalues;
...
int num_sums1, num_sums2, num_sums3;
int num_focals=1, cur_focal=0;
char **sumstems, **sumstems2;
int *pritraits, *pritraits2;
int *sumpops, *sumpops2;
char **bulknames;
int metasum;

int gotfreq;
double *nss, *nss2, *nss3, *nss4, *rnss, *tnss, *snss, *snss2, **Mnss;
double *chis, *chis2, *chis3, *chis4, *rchis, *tchis, *schis, *schis2, **Mchis;
double *rhos, *rhos2, *rhos3, *rhos4, *rrhos, *trhos, *srhos, *srhos2, **Mrhos;
double *a1freq, **Ma1freq;

int num_quants, *keepquants, num_cats, num_covars, num_envs, num_fixed, num_fixed2, num_ruants, *keepruants, num_rats, num_rands;
double *covar, *rovar, *thetas, *thetasds, *thetapvas, covher, topher;
...
unsigned short *cors_short, **Dcors_short;
double *cors, *cors2, *cors3, *cors4, *datasqs, *tally1, *tally2, *tally3, *tally4;
int *replace;
...
int num_males, num_females, *sexes, *parpreds;

double *Pscales, *Pscales2, *Pscales3, *Pvarphens, *Plambdas, *Proots, *Pcals, *Pcals2, *Pspamax;
...
cholmod_dense *chol_B, *chol_B2;
cholmod_dense *chol_S, *chol_S2;
int *chol_Ti, *chol_Tj;
...
int num_try, num_left, num_hers1, num_hers2, num_small, num_full;
int useped, highstruct, usecal, useridge, usecomp;

int *pedtops;
double *pedscales, *pedhers, *pedprs, *pedgammas, *pedsds, *pedeffs, *pedmse;
...
int *Luse;
double *Umat, *Umat2;
double *Lmat, *Lmat2, *Lmat3, *Lmat4, *Gmat, *Emat, *Wmat, *Wmat2, *Wmat3, *Wmat4, *Wmat5, *Ymat;

int *blockstarts, *blockends;
int *highlds;
...
off_t **Dindexes, *Dtemp;
int *Dns, *Dnp, *Dnp2, **Dkp, **Dkp2, ***Dsizes, ***Duse, ***Duse2, ***Dsigns;
int **Dchr;
double **Dbp;
char ***Dpreds, **Dal1, **Dal2;
double *sigma, *omega, *comat, *comat2, *comat3, *comat4;

//pca, decompose, adjust-grm and others

float *Z_single, *ZTZ_single, *kinZ_single, *ZTkinZ_single, *W_single, *WZTkinZ_single;

//stats, scores, making phenotypes, snps, inflation, etc

int *presents, *hets;
int num_scores=0;
double *STS, *STS2, *STM, *STM2;
double *indsds, *predmeans, *predvars, *predtops, *predcors, *predweights, *predsds;
...
int *sR1, *sR2;
double *sX, *sZ, *sT, *sXTX, *sXTX2, *sP, *sP2;
...
double *Y, *Yadj, *Yadj2, *Yadj3, *YTdata, *YTdata2, YTCY;
...
unsigned short *readshorts, *writeshorts;
int readint, readint2, readint3, *readints, writeint;
float readfloat, *readfloats, writefloat, *writefloats;
double readdouble, readdouble2, *readdoubles;

char readchar, readchar2, *rs, *rs2;
char **readstrings, readstring[500], readstring2[500], readstring3[500], readstring4[500], readstring5[500];
char **writestrings, writestring[500];
char cmd[2000];

int bsize;
char *buffer, *bptr, *bptr2;
