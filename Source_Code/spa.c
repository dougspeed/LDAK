...
int spa_test(double score2, double *data, int ns, int num_knots, double *knots, int num_bins, double *bins, double **CGF0, double **CGF1, double **CGF2, double **CGF3, double *stats, double scale2)
...
stats[2]=(ww+pow(ww,-1)*log(vv/ww))*scale2;
stats[1]=stats[0]/stats[2];
stats[3]=erfc(fabs(stats[2])*M_SQRT1_2);
