...
//At end, num_samples_use will be number of valid offspring - keepsamps has length 2*num_samples_use, and indexes offspring, then parent
...
if(count==0)
{
if(duos==1){printf("Error, none of the %d samples have least one parental ID\n\n", num_samples_use);}
if(duos==2){printf("Error, none of the %d samples have paternal IDs\n\n", num_samples_use);}
if(duos==3){printf("Error, none of the %d samples have maternal IDs\n\n", num_samples_use);}
exit(1);
}
...
check_respfile(respfile, usedids, num_samples_use, ids3, num_resps_use, keepresps, num_resps, missingvalue, 0);
...
if(count==0)
{
if(duos==1){printf("Error, none of the %d samples have phenotypes and at least one parental ID\n\n", num_samples_use);}
if(duos==2){printf("Error, none of the %d samples have phenotypes and paternal IDs\n\n", num_samples_use);}
if(duos==3){printf("Error, none of the %d samples have phenotypes and maternal IDs\n\n", num_samples_use);}
exit(1);
}
...
if(count2==0)
{
if(duos==1){printf("Error, none of the %d samples have phenotypes and exactly one parent in the data\n\n", num_samples_use);}
if(duos==2){printf("Error, none of the %d samples have phenotypes and their father in the data\n\n", num_samples_use);}
if(duos==3){printf("Error, none of the %d samples have phenotypes and their mother in the data\n\n", num_samples_use);}
exit(1);
}
