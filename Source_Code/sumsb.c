...
read_sumsfile(sumsfile, snss, schis, srhos, NULL, count, spreds, sal1, sal2, tagfile, amb, fixn, scaling, 2, checksums, sformat);
...
read_sumsfile(sums2file, snss2, schis2, srhos2, NULL, count, spreds, sal1, sal2, tagfile, amb, fixn2, scaling2, 2, checksums, sformat2);
...
solve_cors(stats, num_parts, gcon, cept, num_blocks, count, stags, svars, ssums, snss, schis, srhos, snss2, schis2, srhos2, tol, maxiter, filename);
