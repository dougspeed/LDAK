...
{printf("Error reading %s; this file should have been created using \"--cut-weights\"\n\n", filename);exit(1);}
...
num_seek=read_scores(blupcentres, blupfactors, keeppreds_use,num_scores, scorefile, num_preds, allpreds, allal1, allal2, predorder, bimfile, -9999, NULL, 2, nonsnp);
...
//mode=113 - join-kins - not here (use_data not 1, 6 or 7)
//mode=114 - calc-kins-direct - data_length is number after filtering

//mode=115 - filter - not here (use_data not 1, 6 or 7)
//mode=116 - add-grm - not here (use_data not 1, 6 or 7)
//mode=117 - sub-grm - if(extract=1), data_length is number after filtering, otherwise not here (use_data not 1, 6 or 7)
//mode=118 - convert-gz - not here (use_data not 1, 6 or 7)
//mode=119 - convert-raw - not here (use_data not 1, 6 or 7)
//mode=120 - calc-sim-grm - not here (use_data not 1, 6 or 7)

///////

//mode=121 - reml - not here (use_data not 1, 6 or 7)
...
//mode=123 - he - not here (use_data not 1, 6 or 7)
//mode=124 - pcgc - not here (use_data not 1, 6 or 7)
//mode=125 - reml-predict - not here (use_data not 1, 6 or 7)

//mode=126 - fast-reml - not here (use_data not 1, 6 or 7)
...
//mode=133 - solve-null - not here (use_data not 1, 6 or 7)

//mode=135 - mega-analyse - data_length is number after filtering
...
//mode=139 - join-genes-reml - if(cut1!=-9999), data_length is number after filtering, otherwise not here (use_data not 1, 6 or 7)
//mode=140 - kvik-step3 - data_length is number after filtering

////////

//mode=141 - calc-tagging - data_length is number after filtering
//mode=142 - join-tagging - not here (use_data not 1, 6 or 7)
//mode=143 - merge-tagging - not here (use_data not 1, 6 or 7)
//mode=144 - reduce-tagging - not here (use_data not 1, 6 or 7)
//mode=145 - calc-overlaps - data_length is number after filtering

//mode=146 - sum-hers - not here (use_data not 1, 6 or 7)
//mode=147 - sum-cors - not here (use_data not 1, 6 or 7)
//mode=149 - calc-exps - not here (use_data not 1, 6 or 7)
//mode=150 - calc-posts - not here (use_data not 1, 6 or 7)
...
//mode=157 - join-cors - not here (use_data not 1, 6 or 7)
...
blupcentres=malloc(sizeof(double*)*num_scores);
blupfactors=malloc(sizeof(double*)*num_scores);
data_length=read_scores(blupcentres, blupfactors, keeppreds_use, num_scores, scorefile, num_preds, allpreds, allal1, allal2, predorder, bimfile, num_preds_use, keeppreds, 0, nonsnp);
}

////////

//mode=161 - pca - not here (use_data not 1, 6 or 7)
...
//mode=163 - decompose - not here (use_data not 1, 6 or 7)
//mode=164 - adjust-grm - not here (use_data not 1, 6 or 7)

//mode=166 - truncate -grm- not here (use_data not 1, 6 or 7)
//mode=167 - pca-grm - not here (use_data not 1, 6 or 7)
//mode=168 - square-grm - not here (use_data not 1, 6 or 7)
//mode=169 - gxemm-iid - not here (use_data not 1, 6 or 7)
//mode=170 - gxemm-free - not here (use_data not 1, 6 or 7)
...
blupcentres=malloc(sizeof(double*)*num_scores);
blupfactors=malloc(sizeof(double*)*num_scores);
if(strcmp(scorefile,"blank")!=0){data_length=read_scores(blupcentres, blupfactors, keeppreds_use, num_scores, scorefile, num_preds, allpreds, allal1, allal2, predorder, bimfile, num_preds_use, keeppreds, 0, nonsnp);}
else{data_length=read_scores(blupcentres, blupfactors, keeppreds_use, num_scores, morefile, num_preds, allpreds, allal1, allal2, predorder, bimfile, num_preds_use, keeppreds, 1, nonsnp);}
}
...
//mode=174 - make-snps - not here (use_data not 1, 6 or 7)
...
//mode=176 - jackknife - not here (use_data not 1, 6 or 7)
//mode=177 - cut-folds - not here (use_data not 1, 6 or 7)
//mode=178 - find-gaussian - not here (use_data not 1, 6 or 7)
//mode=179 - winners-curse - not here (use_data not 1, 6 or 7)
//mode=180 - impute-summaries - data_length is number after filtering

////////

//mode=181/182/183/184/185 - making data - not here (use_data not 1, 6 or 7)
//mode=186/187/188/189 - condensing data -  - data_length is number after filtering
//mode=190 - calc-sim-data - not here (use_data not 1, 6 or 7)
