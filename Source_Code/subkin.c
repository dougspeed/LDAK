...
{printf("Error X27, please tell Doug (%d and %d)\n\n", count2, data_length);exit(1);}
...
stand_data(data, centres+bitstart, mults+bitstart, sqdevs+bitstart, rates+bitstart, infos+bitstart, num_samples_use, bitlength, missingvalue, -9999, 0, -9999, weights+bitstart, 2);
