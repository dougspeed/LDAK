...
//Get exps based on indhers or stats, and get correlations
...
if(strcmp(indhers,"blank")==0){fprintf(output,"Computing per-predictor heritabilities\n");}
else{fprintf(output,"Computing predictor means and variances\n\n");}
fclose(output);
...
{
if(num_fixed>1||strcmp(sampwfile,"blank")!=0)	//adjust for covariates
